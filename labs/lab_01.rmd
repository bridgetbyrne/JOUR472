...
**Q1** Which department has the highest mean (average) number of seats for its classes? You need to show the department with the highest average first. Which one is the most surprising/interesting to you? "Engineering, Cooperative Education," I'm surprised it's not buinsess or computure science. 
**A1** 
...
**A4** I checked my answer with a classmate, and we did it the same way so I'm pretty confident the answer is right. This can not be the best way to go about this because all the "NA"s force you to search through the table by eye. I feel like it would be similar to do this in Excel. 
...
**A5** Which department has the most instructors? Which department has the fewest? Business has the  most instructors, and five departments only have one instructor.
