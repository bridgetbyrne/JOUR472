...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** there are eight colomns:Object ID, Zip Code 2, Zip Name, Existing, Zipcode 1, Shape_leng, Shape_Area, geomotry 
...
**Task** Run the following code. Describe the output in the space below. **Answer**A map of maryland, problen down by zip code. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of maryland broken down by county 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A map of maryland broken down by counties and zip codes
...
**Task** Run the following code. Describe the output in the space below. **Answer** A table of the number of foreclosures by zip codes. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A table of all foreclosures  
...
**Task** Run the following code. Describe the output in the space below. **Answer** a temperature map with lighter colors indicating more foreclosures. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** a table with population broken dowm by county and a table with forceclosures broken down by counties. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** Maryland population broken down by county 
...
**Task** Run the following code. Describe the output in the space below. **Answer** Fore closure notices broken down by county
...
**Task** Run the following code. Describe the output in the space below. **Answer** Population broken down by county 
...
**Task** Run the following code. Describe the output in the space below. **Answer** Number of foreclosures broken down by county 
...
**Task** Run the following code. Describe the output in the space below. **Answer** foreclosure rate broken down by county 
...
**Task** Run the following code. Describe the output in the space below. **Answer** A heatmap of maryland, broken down by county, with lighter colors indicating a higher foreclosure rate. 
