...
**Answer** Thdere are "NA" entries in the catagory variable, but that does not make sense. There are also no loans for 2009, which stands out because all other years have loan data. 2013 has a category for "L" and 2017 has a category "contract." A number of things just seem like someone made a mistake. 
...
**Answer** 60 is the smallest grant, which seems off. Most grants are north of 2,000, it looks like. 
...
**Answer** strg_to_upper puts the term in all caps, so line 182 mutates to source, grantee, and description column to all caps. 
...
**Answer** A person/organization could receive more than one grant, so I think there could be as many duplicates as whatever the max number of grants given out is. 
...
**Answer**  It's the same result but in lower case now. 
