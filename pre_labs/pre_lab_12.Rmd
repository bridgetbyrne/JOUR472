...
**Answer** The 2023 press releases start in September, and the dates are character variables, which is a problem. 
...
**Answer**  I want a variable that gives more of a summary about the subject than the titles do.  
```{r}
...
tags there are in the HTML source? **Answer** There are a few you don't need, like the socials and the menu items. 
...
tags. Describe the output: **Answer** This gives much simplier lines, there is not HTML and it's just the text. It's easier to see the ones you don't need this way. 
...
**Answer** This turned the text into a dataframe. 
