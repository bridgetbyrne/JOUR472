...
https://datawrapper.dwcdn.net/UYF63/1/
...
md_gov_county <- md_gov_county |> clean_names() |>
  mutate(total_votes = sum(cox + moore +lashar + harding + write_ins)) |>
  mutate(wes_moore_percentage = (moore / total_votes) * 100)
...
it did not show the whole county. It only showed Maryland.
...
Now each county has the county name and the precentage of votes Moore recived when you click. 
...
https://datawrapper.dwcdn.net/vPCQK/1/ 
