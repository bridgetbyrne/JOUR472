...
**Answer**  We don't want to change the original variable incase there is a mistake and you need to redo your work. 
...
**Answer** 41011 theatre with more than 15 seats. 
...
**Answer** It looks like R knows that the values are dates because it says <dates>, instead of <dbl> or <chr>
...
**Answer** it's creating a varible for the total votes by totaling the votes in cox, moore, lasher, wallace and Write_ins
...
**Answer** it's added another column with the percent of the vote Moore recived.  
...
**Answer** This is more useful because you can tell which county support Moore the most and which support Moore the least. 
...
I asked chatGPT, "What other  tidyverse functions are similar to str_to_upper?" 

str_to_lower: concerts the characters to lowercase
toupper: converts characts to uppercase
...
**Answer** This is sorting the voters by state, expect it wants only the states list and all others to fall into the "NA"catagory. 
...
**Answer** No, this does not make sense because how can there non-whole numbers? You can't have .82 of a voter. 
...
1. Which classes in the journalism school have the most students and which have the least? rank in order. 

2. Which candidate has the lowest precentage of votes in each county? 

3. How many voters are there in each states that start with the letter M? 
