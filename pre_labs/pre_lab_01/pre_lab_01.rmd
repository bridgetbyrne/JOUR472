...
**Answer** 60712 obs. of 8 varuables 
...
**Answer** The output is a table of course offering by term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Its now sorted from greatest to smallest, instead of chronlogically. 
...
**Answer** It's now grouped by term and department. 
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Instead of being sorted by department, it's ranked by seat total, from biggest to smallest.
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** It's the same chart but with the added information of mean and median seat counted. 
...
**Answer** The code block has min and max functions, which adds a column where you can sort by largest and smallest number of seats. 
...
1.  Which department has the most instructors? Which department has the fewest?

2.  Which instructors are listed for the most classes? 

3.  What percent of listings are for graduate classes? 
